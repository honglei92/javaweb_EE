...
<body class="body">
  ...
  %>
    	<ul>
    		...
    		<li><a href="login.html"><img src="images/zhuxiao.png">注销</a></li>
    	</ul>
    </div>
    <div id="content">
...
<TABLE id=idSlider2 border=0 cellSpacing=0 cellPadding=0>
  <TBODY>
<TR>
<TD class="td_f"><A href="http://www.baidu.com"><IMG src="images/c41685928056402cdd6325ef138ba0f4.jpg"></A></TD>
<TD class="td_f"><A href="http://www.baidu.com"><IMG src="images/b43ffd2beb1f7869520b4f9e74c83b43.jpg"></A></TD>
<TD class="td_f"><A href="http://www.baidu.com"><IMG src="images/2fe317dfc27cdf9e6feadb9229732ed6.jpg"></A></TD>
<TD class="td_f"><A href="http://www.baidu.com"><IMG src="images/da5875193952ae917ae9c5cfb75238d7.jpg"></A></TD>
<TD class="td_f"><A href="http://www.baidu.com"><IMG src="images/240992ae07b07fdd70e36992669c62e4.jpg"></A></TD>
</TR>
  </TBODY>
</TABLE>
<UL id="www_zzjs_net" class="zzjs"></UL>
</DIV>
<SCRIPT>
...
for(var i = 0, n = st._count - 1; i <= n;){
 (nums[i] = $("www_zzjs_net").appendChild(document.createElement("li"))).innerHTML = ++i;
}
